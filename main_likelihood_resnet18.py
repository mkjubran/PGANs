...
import data 
import nets
import train_likelihood_resnet18
import shutil

import PGAN_VAE_resnet18
...
train_likelihood_resnet18.train_PGAN_VAE(dat, netG, args)

#### train a given model
#if args.model == 'dcgan':
#    train_TB.dcgan(dat, netG, netD, args)
#elif args.model == 'presgan':
#    train_TB.presgan(dat, netG, netD, log_sigma, args)
#else:
