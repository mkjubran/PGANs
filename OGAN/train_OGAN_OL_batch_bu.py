...
def OL_sampleG1_applyE2G2(args, device, netG1, netG2, netE2, netES, optimizerES, scale, logsigmaG2):
 ...
 if True:
  ...
  likelihood_sample = engine_OGAN.get_likelihood(args,device,netES,optimizerES,samples_G1,netG2,logsigmaG2,args.ckptOL_E2)
...
def OL_sampleG2_applyE1G1(args, device, netG2, netG1, netE1, netES, optimizerES, scale, logsigmaG1):
 ...
 if Ture:
  ...
  likelihood_sample = engine_OGAN.get_likelihood(args,device,netES,optimizerES,samples_G2,netG1,logsigmaG1,args.ckptOL_E1)
  overlap_loss_sample =  -1*likelihood_sample
