...
# define a Conv VAE - Encode and decode using VAE (No PGAN)
class ConvVAEncoderDecoder(nn.Module):
    def __init__(self,args):
        ...
        #self.dec1 = nn.ConvTranspose2d(in_channels=100, out_channels=init_channels*16, 4 , 1, 0)
        #self.dec2 = nn.ConvTranspose2d(in_channels=init_channels*16, out_channels=init_channels*8, 4, 2, 1)
        #self.dec3 = nn.ConvTranspose2d(in_channels=init_channels*8, out_channels=init_channels*4, 4, 2, 1)
        #self.dec4 = nn.ConvTranspose2d(in_channels=init_channels*4, out_channels=init_channels*2, 4, 2, 1)
        #self.dec5 = nn.ConvTranspose2d(in_channels=init_channels*2, out_channels=image_channels, 4, 2, 1)
