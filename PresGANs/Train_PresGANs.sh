...
python3 main_TB.py --dataset mnist --model presgan --lambda_ 0.01 --gpu 1 --save_imgs_every 5\
                            --restrict_sigma 1 --sigma_min 0.001 --sigma_max 0.3

#python3 main_TB.py --dataset mnist --model presgan --lambda_ 0 --gpu 0 --save_imgs_every 5\
#                            --restrict_sigma 1 --sigma_min 0.001 --sigma_max 0.3
